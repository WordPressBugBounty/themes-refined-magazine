...
function refined_magazine_scripts()
{
    ...
    wp_enqueue_style('google-fonts', '//fonts.googleapis.com/css?family=Slabo+27px|Muli&display=swap');
        ...
        /*Font-Awesome-master-refined-magazine*/
        $refined_magazine_fontawesome = !empty($refined_magazine_theme_options['refined-magazine-font-awesome-version-loading']) ? esc_attr($refined_magazine_theme_options['refined-magazine-font-awesome-version-loading']) : 'version-4';

        if ($refined_magazine_fontawesome == 'version-5') {
            /*Font-Awesome-master*/
        ...
        } elseif ($refined_magazine_fontawesome == 'version-6') {
            /*Font-Awesome-master*/
