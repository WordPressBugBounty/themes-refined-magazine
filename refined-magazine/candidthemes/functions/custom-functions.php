...
<li id="comment-<?php comment_ID(); ?>" <?php comment_class(empty($args['has_children']) ? '' : 'parent'); ?>>
  <article id="div-comment-<?php comment_ID(); ?>" class="comment-body"
    <?php refined_magazine_do_microdata('comment-body'); ?>>
    <footer class="comment-meta">
      ...
      <p class="comment-awaiting-moderation">
        <?php _e('Your comment is awaiting moderation.', 'refined-magazine'); // WPCS: XSS OK. ?></p>
      <?php endif; ?>
    </footer><!-- .comment-meta -->
...
if (!function_exists('refined_magazine_custom_body_class')) :
    function refined_magazine_custom_body_class($classes)
    {
        ...
        if (!empty($refined_magazine_theme_options['refined-magazine-font-awesome-version-loading'])) {
            $classes[] = 'refined-magazine-fontawesome-' . $refined_magazine_theme_options['refined-magazine-font-awesome-version-loading'];
        }
